...
function Projects() {
  const projectsData = [
    ...
    },
    {
      ...
      description:
        "WhereApp is an innovative mobile application designed to connect people nearby by encouraging them to meet through local events. The app facilitates social interactions by allowing users to chat, form groups, and access special offers. Developed for Android using Kotlin and Jetpack Compose, WhereApp ensures a seamless and modern user experience. It includes a robust verification process powered by Firebase Authentication, enhancing user security and trust. Additionally, the integration of the Google Maps API enables users to navigate to events and locations effortlessly. By leveraging these technologies, WhereApp aims to foster community and enhance social connectivity in local areas.",
    },
  ];
  return (
    <>
      <section className="projects-section">
        <span className="section-title">Projects & Experience</span>
        <p className="projects-description">
          Welcome to my Projects and Experience section! I am currently involved
          in multiple personal and group projects where I have used technologies
          like Node.js, Express, JavaScript, Ionic, React, TypeScript, Neo4j,
          PostgreSQL, Kotlin, Jetpack Compose, Firebase Authentication, and
          Google Maps API. These projects have helped me develop skills in
          connecting users, building communities, and enhancing social
          interactions.
        </p>
